...
export default async function handler(
  ...
  try {
    const result =
      ...
      await sql`create table if not exists users2(uid serial primary key, Fname varchar(255), Lname varchar(255),username varchar(255), DOB DATE, Address varchar(255), Phone varchar(10), Email varchar(319), Password varchar(255), regKey varchar(255));`;
